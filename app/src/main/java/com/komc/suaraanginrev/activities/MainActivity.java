...
public class MainActivity extends AppCompatActivity {
    ...
    public void getData(){
        String url = "https://newsapi.org/v2/top-headlines?country=id&apiKey=9d2d1f1df59f4bc5904171d1285cb7e2";
        ...
        JsonObjectRequest request =new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response){
                ...
                try {
                    ...
                    NewsAdapter newsAdapter = new NewsAdapter(MainActivity.this, newsList, listener);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if(response != null && response.data != null){
                    Toast.makeText(MainActivity.this,"errorMessage1:"+response.statusCode, Toast.LENGTH_SHORT).show();
                }else{
                    String errorMessage=error.getClass().getSimpleName();
                    if(!TextUtils.isEmpty(errorMessage)){
                        Toast.makeText(MainActivity.this,"errorMessage2:"+errorMessage, Toast.LENGTH_SHORT).show();
                        }
                }
            }
        }){
