...
public class BusinessActivity extends AppCompatActivity {
    ...
    private void openFragmentActivity() {
        Intent intent = new Intent(BusinessActivity.this, FragmentActivity.class);
        startActivity(intent);
    }

    private void openSettingActivity() {
        Intent intent = new Intent(BusinessActivity.this, SettingActivity.class);
        startActivity(intent);
    }
        ...
        JsonObjectRequest request =new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response){
                ...
                try {
                    ...
                    NewsAdapter newsAdapter = new NewsAdapter(BusinessActivity.this, newsList, listener);
                    recyclerView.setAdapter(newsAdapter);


                } catch (JSONException e) {
                    String errorMsg = e.getMessage();
                    Toast.makeText(BusinessActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if(response != null && response.data != null){
                    Toast.makeText(BusinessActivity.this,"errorMessage1:"+response.statusCode, Toast.LENGTH_SHORT).show();
                }else{
                    String errorMessage=error.getClass().getSimpleName();
                    if(!TextUtils.isEmpty(errorMessage)){
                        Toast.makeText(BusinessActivity.this,"errorMessage2:"+errorMessage, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        }){
