...
public class ScienceActivity extends AppCompatActivity {
    ...
    private void openFragmentActivity() {
        Intent intent = new Intent(ScienceActivity.this, FragmentActivity.class);
        startActivity(intent);
    }

    private void openSettingActivity() {
        Intent intent = new Intent(ScienceActivity.this, SettingActivity.class);
        startActivity(intent);
    }
    ...
    public void getData(){
        String url = "https://newsapi.org/v2/top-headlines?country=id&category=science&apiKey=9d2d1f1df59f4bc5904171d1285cb7e2";
        ...
        JsonObjectRequest request =new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response){
                ...
                try {
                    ...
                    NewsAdapter newsAdapter = new NewsAdapter(ScienceActivity.this, newsList, listener);
                    recyclerView.setAdapter(newsAdapter);


                } catch (JSONException e) {
                    String errorMsg = e.getMessage();
                    Toast.makeText(ScienceActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if(response != null && response.data != null){
                    Toast.makeText(ScienceActivity.this,"errorMessage1:"+response.statusCode, Toast.LENGTH_SHORT).show();
                }else{
                    String errorMessage=error.getClass().getSimpleName();
                    if(!TextUtils.isEmpty(errorMessage)){
                        Toast.makeText(ScienceActivity.this,"errorMessage2:"+errorMessage, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        }){
