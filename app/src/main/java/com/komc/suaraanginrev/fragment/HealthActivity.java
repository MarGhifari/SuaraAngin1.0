...
public class HealthActivity extends AppCompatActivity {
    ...
    private void openFragmentActivity() {
        Intent intent = new Intent(HealthActivity.this, FragmentActivity.class);
        startActivity(intent);
    }

    private void openSettingActivity() {
        Intent intent = new Intent(HealthActivity.this, SettingActivity.class);
        startActivity(intent);
    }
    ...
    public void getData(){
        String url = "https://newsapi.org/v2/top-headlines?country=id&category=health&apiKey=9d2d1f1df59f4bc5904171d1285cb7e2";
        ...
        JsonObjectRequest request =new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response){
                ...
                try {
                    ...
                    NewsAdapter newsAdapter = new NewsAdapter(HealthActivity.this, newsList, listener);
                    recyclerView.setAdapter(newsAdapter);


                } catch (JSONException e) {
                    String errorMsg = e.getMessage();
                    Toast.makeText(HealthActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if(response != null && response.data != null){
                    Toast.makeText(HealthActivity.this,"errorMessage1:"+response.statusCode, Toast.LENGTH_SHORT).show();
                }else{
                    String errorMessage=error.getClass().getSimpleName();
                    if(!TextUtils.isEmpty(errorMessage)){
                        Toast.makeText(HealthActivity.this,"errorMessage2:"+errorMessage, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        }){
